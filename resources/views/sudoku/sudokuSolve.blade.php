                ...
                <div class="card text-center" id="controlCard">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item btn-group">
                            ...
                            <button class="btn btn-info" id="pencilBtn" aria-pressed="false" type="button"></button>
                            <button class="btn btn-primary" id="finishBtn" type="button" onclick="validatePostFinish()"></button>
                            <button class="btn btn-danger" id="restart" type="button"></button>
                        </li>
                    </ul>
                </div>
            </div>
